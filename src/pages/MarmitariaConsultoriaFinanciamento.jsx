  ...
  perguntasConsultoria: [
    {
      ...
      correta: 'a',
      explicacao: 'PMT = R$20.000 × [0,038 ÷ (1 − 1,038^−48)] = R$893/mês. Total = R$893 × 48 = R$42.864. Juros totais = R$22.864 (!!). Com a entrada de R$2.000, custo total = R$44.864 por um bem de R$22.000 — multiplicador de 2,04x. O banco digital "sem burocracia" é o crédito mais caro das 3 opções.',
    },
    {
      id: 'c2',
      ...
      opcoes: [
        ...
        { id: 'c', texto: 'Parcela inicial R$611, final R$611, total R$22.000 — só o principal' },
        { id: 'd', texto: 'Parcela inicial R$1.200, final R$200, total R$26.000 — bom negócio' },
      ],
      correta: 'b',
      explicacao: 'SAC: amortização = R$22.000 ÷ 36 = R$611/mês. Juros mês 1 = R$22.000 × 1,65% = R$363. Parcela inicial = R$611 + R$363 = R$974. Juros mês 36 = R$611 × 1,65% = R$10. Parcela final = R$611 + R$10 = R$621. Total pago ≈ R$28.386. Economia vs Proposta A: R$42.864 − R$28.386 = R$14.478 — quase dois terços do valor do bem em juros economizados escolhendo a fonte certa.',
    },
    {
      id: 'c3',
      ...
      correta: 'a',
      explicacao: 'PMT = R$22.000 × [0,012 ÷ (1 − 1,012^−24)] = R$1.042/mês. Total = R$25.008. Juros totais = R$3.008 — muito menor que as outras opções! Porém a parcela de R$1.042 em 24 meses exige disciplina de caixa. O Crediamigo tem também limite de crédito menor para MEI iniciante — precisa verificar elegibilidade. Se Aparecida se qualificar, é a melhor opção em custo total.',
    },
    {
      id: 'c4',
      ...
      correta: 'b',
      explicacao: 'Receita extra bruta: R$8.640/mês. Margem de contribuição 45%: R$8.640 × 45% = R$3.888/mês de receita adicional líquida. Parcela A: R$893 → sobra R$2.995. Parcela B: R$974 (inicial) → sobra ~R$2.914. Parcela C: R$1.042 → sobra R$2.846. Todas as propostas são viáveis financeiramente — o investimento retorna mais do que custa. A diferença entre elas é quanto sobra. Isso valida a decisão de tomar crédito, mas a escolha da proposta importa muito.',
    },
    {
      id: 'c5',
