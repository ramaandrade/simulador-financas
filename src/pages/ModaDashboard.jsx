          ...
          >
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', marginTop: '1rem', gap: '0.75rem' }}>
              {(mod.id === 1 || mod.id === 2 || mod.id === 3 || mod.id === 4) && (
                <button
                  onClick={(e) => { e.stopPropagation(); if (consultoraLiberada(mod.id)) navigate(mod.id === 1 ? '/moda/consultoria-custos' : mod.id === 2 ? '/moda/consultoria-precificacao' : mod.id === 3 ? '/moda/consultoria-capital-giro' : '/moda/consultoria-planejamento'); }}
                  style={{
