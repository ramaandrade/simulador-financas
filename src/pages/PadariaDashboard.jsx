          ...
          >
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', marginTop: '1rem', gap: '0.75rem' }}>
              {(opt.id === 1 || opt.id === 2 || opt.id === 3 || opt.id === 4) && (
                <button
                  onClick={(e) => { e.stopPropagation(); if (consultoraLiberada(opt.id)) navigate(opt.id === 1 ? '/padaria/consultoria-custos' : opt.id === 2 ? '/padaria/consultoria-precificacao' : opt.id === 3 ? '/padaria/consultoria-capital-giro' : '/padaria/consultoria-planejamento'); }}
                  style={{
